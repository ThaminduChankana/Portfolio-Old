...
export const Extra = () => {
	return (
		<section className="extra" id="extras">
			<div className="container">
				...
				<Row>
					<div className=" extra-bx wow zoomIn" style={{ height: "auto" }}>
								...
								<AppearingContainer>
									<div>
										<h5 style={{ width: "100%", padding: "0 10px 0 10px", marginTop: 10 }}>
											...
											&nbsp;Former Committee Member SLIIT Faculty Of Computing<br></br>Students' Community
										</h5>
									</div>
								</AppearingContainer>
								<br></br>
								<AppearingContainer>
									<div>
										<h5 style={{ width: "100%", padding: "0 10px 0 10px", marginTop: 10 }}>
											...
											&nbsp;Assistant Treasurer MS Club of SLIIT
										</h5>
									</div>
								</AppearingContainer>
								<br></br>
						...
						<h3 style={{ padding: 10 }}>
							Please visit my LinkedIn profile or view my resume to get the updated details of my Extra Curricular
							Activities...
						</h3>
